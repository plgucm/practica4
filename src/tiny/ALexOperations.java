...
public class ALexOperations {
	...
	public UnidadLexica unidadNat() {
		return new UnidadLexica(alex.fila(), ClaseLexica.NUMERO_NATURAL,
				alex.lexema());
	}

	public UnidadLexica unidadReal() {
		return new UnidadLexica(alex.fila(), ClaseLexica.NUMERO_REAL,
				alex.lexema());
	}
	...
	public UnidadLexica unidadVariables() {
		return new UnidadLexica(alex.fila(), ClaseLexica.VARIABLES,
				alex.lexema());
	}

	public UnidadLexica unidadSubprograms() {
		return new UnidadLexica(alex.fila(), ClaseLexica.SUBPROGRAMS,
				alex.lexema());
	}

	public UnidadLexica unidadSubprogram() {
		return new UnidadLexica(alex.fila(), ClaseLexica.SUBPROGRAM,
				alex.lexema());
	}
	...
	public UnidadLexica unidadToDouble() {
		return new UnidadLexica(alex.fila(), ClaseLexica.TODOUBLE,
				alex.lexema());
	}
